...
**Priority: P4 (after core in-housing)**
**Goal: Download media assets (tweet photos, videos, article images) to configurable path. Replace any ft-cli media download dependency.**
